...
<textarea v-model="contents" class="block w-1/2 p-4 overflow-auto transform rotate-0 rounded shadow resize border m-4 text-xs font-mono" style="height: 400px" />
