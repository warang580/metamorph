...
<textarea class="block w-1/2 p-4 overflow-auto transform rotate-0 rounded shadow resize border m-4 font-mono text-xs" v-model="scene" v-if="editable" style="height: 400px" />
...
<input type="text" class="border p-4 w-1/2 block" v-model="wave" />
<Inspector  />
</template>
